public final class Message {
    ...
    public static final int CIPHERS=3;
    public static final int NUMBERICALRANGE=9;
    public static final int NUMBEROFRETRY=9;
    public  static final String INPUT_BALL="숫자를 입력해주세요";
    public  static final String STRIKE="스트라이크";
    public  static final String BALL="볼";
    public static final String BALLNET="볼넷";
